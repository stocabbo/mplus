...
function renderPlans(plans, missing) {
  results.replaceChildren();
  if (!plans.length) {
    results.innerHTML = '<p class="planner-error">Le giornate lavorative disponibili non bastano. Estendi il periodo o rimuovi alcune esclusioni.</p>';
    return;
  }
...
form.addEventListener('submit', event => {
  ...
  renderPlans(buildPlans(missing, days), missing);
});
